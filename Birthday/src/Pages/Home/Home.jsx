    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex justify-center h-full items-center text-white  ">
        <div className="min-w-[420px] border-1 rounded-md  border-cyan-400 bg-black/40 ">
          ...
          <img
            src="https://png.pngtree.com/png-clipart/20230930/original/pngtree-a-happy-cute-little-girl-png-image_13194907.png"
            alt=""
            className="w-32 h-32 object-contain mx-auto bg-transparent"
          />
        ...
        "
            >
              <span className="text-cyan-400 w-[250px]">
                A little surprise for you.Please click
              </span>

              <div>
                <button
                  onClick={() => handlebirthDate()}
                  className=" bg-gradient-to-r from-blue-500 to-purple-500 px-2 py-1 rounded-md transform duration-300 hover:bg-gradient-to-l from-blue-500 to-purple-500 h-8"
                >
                  click Here
                </button>
              </div>
